...
int diagonalDifference(vector<vector<int>> arr) {
    ...
    for (int i = 0; i <= arr.size()-1; i++) {
        ...
        //cout << arr[i][i] << endl;
        //cout << leftToRightDiagonalSum << endl;
        
        rightToLeftDiagonalSum += arr[i][arr.size()-1-i];
        //cout << arr[i][arr.size()-1-i] << endl;
        //cout << rightToLeftDiagonalSum << endl;
    ...
    diagonalDifference = leftToRightDiagonalSum - rightToLeftDiagonalSum;
